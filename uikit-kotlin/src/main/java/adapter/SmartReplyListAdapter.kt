...
import adapter.SmartReplyListAdapter.SmartReplyViewHolder
 ...
 *
 */
class SmartReplyListAdapter(context: Context) : RecyclerView.Adapter<SmartReplyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, i: Int): SmartReplyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.reply_list_row, parent, false)
