 ...
 *
 */
class CallListAdapter(context: Context) : RecyclerView.Adapter<CallListAdapter.CallViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CallViewHolder {
        ...
        val callListRowBinding: CallListRowBinding = DataBindingUtil.inflate(layoutInflater, R.layout.call_list_row, parent, false)
    ...
    inner class CallViewHolder(var callListRowBinding: CallListRowBinding) : RecyclerView.ViewHolder(callListRowBinding.root)
}