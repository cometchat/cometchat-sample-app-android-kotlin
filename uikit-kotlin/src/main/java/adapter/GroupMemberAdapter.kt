...
import adapter.GroupMemberAdapter.GroupMemberViewHolder
...
//        fontUtils = FontUtils.getInstance(context)
    ...
    inner class GroupMemberViewHolder(var userListRowBinding: UserListRowBinding) : RecyclerView.ViewHolder(userListRowBinding.root)
