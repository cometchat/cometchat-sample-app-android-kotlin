...
import adapter.UserListAdapter.InitialHolder
import adapter.UserListAdapter.UserViewHolder
 ...
 *
 */
class UserListAdapter(context: Context) : RecyclerView.Adapter<UserViewHolder>(), StickyHeaderAdapter<InitialHolder?> {
    ...
    override fun onCreateHeaderViewHolder(var1: ViewGroup?): InitialHolder? {
        return InitialHolder(LayoutInflater.from(var1!!.context).inflate(R.layout.cc_initial_header, var1, false))
    }
    ...
    inner class UserViewHolder(var userListRowBinding: UserListRowBinding) : RecyclerView.ViewHolder(userListRowBinding.root)
