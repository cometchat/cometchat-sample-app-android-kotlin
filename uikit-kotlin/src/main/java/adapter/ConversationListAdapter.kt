 ...
 *
 */
class ConversationListAdapter(context: Context?) : RecyclerView.Adapter<ConversationViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ConversationViewHolder {
        ...
        val conversationListRowBinding: ConversationListRowBinding = DataBindingUtil.inflate(layoutInflater, R.layout.conversation_list_row, parent, false)
    ...
    inner class ConversationViewHolder(var conversationListRowBinding: ConversationListRowBinding) : RecyclerView.ViewHolder(conversationListRowBinding.root)
}