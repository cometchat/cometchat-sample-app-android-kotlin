...
class CallHistoryAdapter(context: Context, callList: List<BaseMessage>): RecyclerView.Adapter<CallHistoryAdapter.CallViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CallViewHolder {
        ...
        val callHistoryRowBinding: CallHistoryRowBinding = DataBindingUtil.inflate(layoutInflater, R.layout.call_history_row, parent, false)
...
//        }
    ...
    inner class CallViewHolder(var callHistoryRowBinding: CallHistoryRowBinding) : RecyclerView.ViewHolder(callHistoryRowBinding.root)
}