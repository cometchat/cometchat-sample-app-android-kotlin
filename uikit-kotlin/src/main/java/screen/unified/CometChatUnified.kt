...
import screen.CometChatGroupListScreen.Companion.setItemClickListener
...
class CometChatUnified : AppCompatActivity(), BottomNavigationView.OnNavigationItemSelectedListener, OnAlertDialogButtonClickListener {
    ...
    private fun setConversationClickListener() {
        CometChatConversationListScreen.Companion.setItemClickListener(object : OnItemClickListener<Any>() {
    ...
    private fun setGroupClickListener() {
        CometChatGroupListScreen.Companion.setItemClickListener(object : OnItemClickListener<Any>() {
            override fun OnItemClick(t: Any, position: Int) {
                group = t as Group
                if (group!!.isJoined) {
    ...
    private fun setUserClickListener() {
        CometChatUserListScreen.Companion.setItemClickListener(object : OnItemClickListener<Any>() {
            override fun OnItemClick(t: Any, position: Int) {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (itemId == R.id.menu_users) {
            fragment = CometChatUserListScreen()
        } else if (itemId == R.id.menu_group) {
            fragment = CometChatGroupListScreen()
        } else if (itemId == R.id.menu_conversation) {
            fragment = CometChatConversationListScreen()
        } else if (itemId == R.id.menu_more) {
            fragment = CometChatUserInfoScreen()
        } else if (itemId == R.id.menu_call) {
            fragment = CometChatCallListScreen()
        }
