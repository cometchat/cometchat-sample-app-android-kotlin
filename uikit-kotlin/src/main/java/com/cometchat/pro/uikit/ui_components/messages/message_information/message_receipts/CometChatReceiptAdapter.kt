...
class CometChatReceiptAdapter(context: Context?) : RecyclerView.Adapter<CometChatReceiptAdapter.ReceiptsHolder>() {
...
//    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ReceiptsHolder {
        return ReceiptsHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cometchat_receipts_item, viewGroup, false))
    }
    ...
    class ReceiptsHolder : RecyclerView.ViewHolder {
        ...
        var ivAvatar: CometChatAvatar? = null
