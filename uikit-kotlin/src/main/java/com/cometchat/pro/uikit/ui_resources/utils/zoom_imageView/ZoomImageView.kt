package com.cometchat.pro.uikit.ui_resources.utils.zoom_imageView
...
public class ZoomImageView(context: Context, attr: AttributeSet?) : androidx.appcompat.widget.AppCompatImageView(context, attr) {
    var matrixs = Matrix()
    var mode = NONE
    var last = PointF()
    var start = PointF()
