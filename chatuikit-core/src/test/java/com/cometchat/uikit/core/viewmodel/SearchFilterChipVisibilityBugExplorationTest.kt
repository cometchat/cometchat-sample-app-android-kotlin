...
/**
 * Test implementation of SearchRepository for bug exploration testing.
 */
private class BugExplorationSearchRepository : SearchRepository {
...
/**
 * Test implementation of FetchConversationsUseCase for bug exploration testing.
 */
private class BugExplorationFetchConversationsUseCase : FetchConversationsUseCase(BugExplorationSearchRepository()) {
...
/**
 * Test implementation of FetchMessagesUseCase for bug exploration testing.
 */
private class BugExplorationFetchMessagesUseCase : FetchMessagesUseCase(BugExplorationSearchRepository()) {
        ...
        test("clicking Unread should result in only Unread and Groups being selected (CONVERSATION group)") {
            runTest(testDispatcher) {
                val viewModel = CometChatSearchViewModel(
                    fetchConversationsUseCase = BugExplorationFetchConversationsUseCase(),
                    fetchMessagesUseCase = BugExplorationFetchMessagesUseCase()
                )
