...
import com.cometchat.sampleapp.kotlin.e2e.helpers.PinSaveRegressionHelper as H
import com.cometchat.sampleapp.kotlin.e2e.helpers.PinSaveRegressionHelper.log
...
/**
 * ENG-38902 regression E2E (View / sample-app-kotlin). One test per QA sub-issue; the Compose
 ...
 *     -Pandroid.testInstrumentationRunnerArguments.class=com.cometchat.sampleapp.kotlin.e2e.PinSaveThreadRegressionE2ETest
 */
...
class PinSaveThreadRegressionE2ETest {
    ...
    fun test01_savedIndicatorSurvivesEdit() {
        ...
        assertNotNull("Composer not in edit mode", composer)
        val editText = composer!!.findObject(By.clazz("android.widget.EditText"))
        assertNotNull("Composer EditText not found", editText)
    ...
    fun test02_savedParentShowsIndicatorInThread() {
        ...
        assertNotNull("Thread screen did not open", E2ETestHelper.waitForComposer(device))
