...
object E2ETestConfig {
    ...
    // TEMP: real creds restored locally for test runs — RE-SCRUB to placeholders before commit.
    val APP_ID: String get() = arg("appId") ?: "YOUR_APP_ID"
    val REGION: String get() = arg("region") ?: "YOUR_REGION"
    ...
    const val MEDIA_FILE_URL = "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
}
