...
import com.cometchat.ai.sampleapp.databinding.ActivityAppCredentialsBinding
import com.cometchat.ai.sampleapp.viewmodels.AppCredentialsViewModel
    ...
    private fun initClickListeners() {
        binding!!.btnContinue.setOnClickListener { v: View? ->
            if (viewModel!!.selectedRegion.value == null) {
                showToast(R.string.app_please_select_app_region)
            } else if (binding!!.etAppId.text.toString().isEmpty()) {
                showToast(R.string.app_invalid_app_id)
            } else if (binding!!.etAuthKey.text.toString().isEmpty()) {
                showToast(R.string.app_invalid_auth_token)
            } else {
                viewModel!!.initUIKit(this, binding!!.etAppId.text.toString(), binding!!.etAuthKey.text.toString())
            }
        }
