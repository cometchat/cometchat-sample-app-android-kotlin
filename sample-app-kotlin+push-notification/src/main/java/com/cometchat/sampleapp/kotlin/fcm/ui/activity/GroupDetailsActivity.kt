...
import com.cometchat.sampleapp.kotlin.fcm.data.enums.GroupAction
import com.cometchat.sampleapp.kotlin.fcm.databinding.ActivityGroupDetailsBinding
import com.cometchat.sampleapp.kotlin.fcm.databinding.AddMembersLayoutBinding
import com.cometchat.sampleapp.kotlin.fcm.databinding.BannedMembersLayoutBinding
import com.cometchat.sampleapp.kotlin.fcm.databinding.GroupMembersLayoutBinding
import com.cometchat.sampleapp.kotlin.fcm.databinding.TransferOwnershipLayoutBinding
import com.cometchat.sampleapp.kotlin.fcm.viewmodels.GroupDetailsViewModel
...
class GroupDetailsActivity : AppCompatActivity() {
    ...
    private fun setHeaderData(group: Group) {
        ...
        binding.tvLeaveGroup.setOnClickListener { view: View? ->
        ...
        binding.tvDeleteGroup.setOnClickListener { view: View? ->
            showAlertDialog(
    ...
    private fun setOptionsVisibility() {
        ...
        binding.tvDeleteGroup.visibility = View.GONE
        binding.viewMembers.visibility = View.GONE
        binding.tvLeaveGroup.visibility = View.GONE
        if (group.isJoined) {
            showGroupMembers()
            when (group.scope) {
                UIKitConstants.GroupMemberScope.PARTICIPANTS -> {
                    binding.viewMembers.visibility = View.VISIBLE
                    binding.tvLeaveGroup.visibility = View.VISIBLE
                }
                ...
                UIKitConstants.GroupMemberScope.ADMIN -> {
                    ...
                    binding.viewMembers.visibility = View.VISIBLE
                    if (group.membersCount > 1) binding.tvLeaveGroup.visibility = View.VISIBLE
                    binding.tvDeleteGroup.visibility = View.VISIBLE
                }
            }
        }
    }
